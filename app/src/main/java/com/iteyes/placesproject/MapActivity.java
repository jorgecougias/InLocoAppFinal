...
import static com.iteyes.placesproject.JsonController.readJsonFromUrl;
import static com.iteyes.placesproject.JsonController.readJsonListCity;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOpenCityList = findViewById(R.id.btn_find);
...
//                            marker.showInfoWindow();
        ...
        btnOpenCityList.setOnClickListener(new View.OnClickListener() {
            @Override
