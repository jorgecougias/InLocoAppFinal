    ...
    public static List<City> getCityList(String jsonText) throws JSONException {
        ...
        for(int i=0; i<list.length(); i++){
            ...
            String name = cityJ.getString("name");
                ...
                JSONObject coord = cityJ.getJSONObject("coord");
                double lat = coord.getDouble("lat");
                double log = coord.getDouble("lon");
            ...
            cityList.add(new City(name, description, Double.parseDouble(maxString), Double.parseDouble(minString),lat,log));
        }
        return cityList;
    }
